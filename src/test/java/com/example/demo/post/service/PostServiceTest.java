...
/**
 * h2나 mockito 없이도 가능한 PostService 테스트
 * 소형 테스트고 매우 빠르다.
...
class PostServiceTest {
    ...
    void init() {
        ...
        TestClockHolder testClockHolder = new TestClockHolder(1_679_530_673_958L);
    ...
    void getById는_존재하는_게시물을_내려준다() {
        ...
        assertThat(result.getWriter().getEmail()).isEqualTo("sylvan0212@gmail.com");
    }
    ...
    void postCreateDto_를_이용하여_게시물을_생성할_수_있다() {
        ...
        assertThat(result.getCreatedAt()).isEqualTo(1_679_530_673_958L);
    }
